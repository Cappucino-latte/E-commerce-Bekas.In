...
const Auth = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!isLogin) {
      localStorage.setItem('bekasUser', JSON.stringify({
        name: formData.name,
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full pl-12 pr-12 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent"
            ...
            {isLogin && (
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm text-primary hover:text-slate-800">
                  Forgot password?
                </a>
              </div>
            )}
            ...
            <button
              type="submit"
              className="w-full bg-primary text-white py-3 rounded-xl font-semibold hover:bg-slate-800 transition-colors"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <button
                ...
                className="ml-1 font-medium text-primary hover:text-slate-800"
              >
